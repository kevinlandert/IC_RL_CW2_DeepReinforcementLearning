...
def main_testagent():
    ...
    seeds = ['2','9','12','22','23','26','34','38','45','49','56','58','62','69','73','77','82','86','90']
    
    for i in range(len(seeds)):
              
        random_seed = seeds[i]
        a = 0.99995 #old 0.99991
        b = 0.001
        c = 0.95
        d = 50
        e = 0.8
        ...
        for run in range(1):
            ...
            result,distance,num_steps = run_test(random_seed,a,b,c,d,e,run,draw = True)
...
def run_test(random_seed,a,b,c,d,e,run,draw = False):
    ...
    # Create an agent
    agent = Agent(a,b,c,d,log_stats = True,debug=False,priority = e)
    ...
    end_time = start_time + 600* 1.5 * (2.8 if draw_greedy_start == 'full' else 1)
    ...
    while time.time() < end_time:
        ...
        if display_on:
            ...
            environment.show(state,draw_greedy_start,agent,new)
    ...
    if draw:
        ...
        draw_cnt = min(num_steps_taken,60000)
